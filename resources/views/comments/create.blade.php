        ...
        <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
            ...
            {{-- <div class="absolute inset-0">
                <iframe width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0" title="map"
                    scrolling="no" src="{{ $post->image_url }}" style="filter: none;"></iframe>
            </div> --}}
           
            <div class="container px-8 mx-auto flex">
                <form action="{{ route('posts.comments.store', $post) }}" method="POST"
                    class="bg-white rounded-lg lg:p-8 w-1/2 flex flex-col  w-full mt-10 md:mt-0 shadow-md">
                    <h2 class="text-gray-900 text-lg mb-3 font-medium title-font">ご予約フォーム</h2>
                    @csrf
                    ...
                    <div class="relative mb-4">
                        <p id="total" name="total" class="mb-4 text-md text-gray-600"></p>
                    </div>
              ...
              <article class="lg:max-w-2xl lg:w-full md:w-1/2 w-5/6 ml-4">
